...
auto_wrap_for_ansi: t.Callable[[t.TextIO, t.Optional[bool]], t.TextIO] | None = None # type: ignore
...
class _AtomicFile:
    ...
    def close(self, delete: bool = False) -> None:
        ...
        # Windows Retry Loop for Atomic Replace
        for i in range(5):
            try:
                ...
                if winerror in (5, 32) and i < 4:
                    if winerror == 5:
                        try:
                            # Attempt to clear read-only attribute if it's causing Access Denied
                            os.chmod(self._real_filename, 0o666)
                        except OSError:
                            pass
                    time.sleep(0.1)
                    continue
